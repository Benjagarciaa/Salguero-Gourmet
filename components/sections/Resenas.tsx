        ...
        {resenas.items.map((r, i) => (
          <Reveal key={i} delay={(i % 2) * 0.08}>
            <figure className="flex h-full flex-col gap-[14px] rounded-lg border border-hairline bg-surface p-6">
              ...
              <figcaption className="flex flex-col gap-1.5 border-t border-hairline pt-[14px] min-[420px]:flex-row min-[420px]:items-center min-[420px]:justify-between min-[420px]:gap-[10px]">
